                            ...
                            <table class="table table-head-bg-primary mt-4">
                                ...
                                @foreach($bumbus as $bum)
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="{{route('bumbu.edit', $bum->id)}}" class="btn btn-warning btn-xs" title="Update Data"><i
                                                    class="fa fa-pencil-alt"></i></a>
                                            <a href="{{route('bumbu.delete', $bum->id)}}" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" class="btn btn-danger btn-xs" title="Hapus Data"><i
